package com.github.hyr0318.materialcoordinatorlayout.widgets;
...
import com.github.hyr0318.materialcoordinatorlayout.utils.UnreadMsgUtils;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDividerWidth > 0) {
            ...
            for (int i = 0; i < mTabCount - 1; i++) {
                ...
                canvas.drawLine(paddingLeft + tab.getRight(), mDividerPadding, paddingLeft + tab.getRight(), height, mDividerPaint);
            }
        }
